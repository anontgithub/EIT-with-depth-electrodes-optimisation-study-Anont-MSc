...
for h = 1:819   %length(tconfig)  
    if ismember(h,errorlist)
        sprintf('skipped loopresult005P_%1$d',h) 
    ...
    full005dataRROinj{h} = datacell;          
end
save('full005dataRROinj.mat','full005dataRROinj') 
